              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex justify-center">
                  <a
                    ...
                    className="bg-gray-800 hover:bg-purple-800 text-gray-400 px-10 py-3 rounded-xl lg:text-xl text-sm font-semibold text-center w-full sm:w-auto max-w-[420px]"
                  >
                    View Code
                  </a>
                </div>
